...
public class PlayerManager : MonoBehaviour
{
    ...
    void CreateController()
    {
        if (PhotonNetwork.IsMasterClient)
        {
            ...
            PhotonNetwork.Instantiate(Path.Combine("PhotonPrefabs", "CAVEPlayerController_1"), new Vector3(-2.0f, 1.17f, 16.0f)/*new Vector3(0, 1, 0)*/, Quaternion.identity * Quaternion.Euler(0.0f, 90.0f, 0.0f));
