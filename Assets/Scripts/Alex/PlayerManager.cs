...
public class PlayerManager : MonoBehaviour
{
    ...
    void CreateController()
    {
        if (PhotonNetwork.IsMasterClient)
        {
            ...
            PhotonNetwork.Instantiate(Path.Combine("PhotonPrefabs", "CAVEPlayerController_1"), new Vector3(-1.05f, 1.8f, 15.6f), Quaternion.identity * Quaternion.Euler(0.0f, 90.0f, 0.0f));
